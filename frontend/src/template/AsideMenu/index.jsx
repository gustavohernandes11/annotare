    ...
    return (
        <Styled.Container>
            ...
            <Category
                ...
                color='grey'
                onClick={() => globalActions.setSelectedCategory(null)} >All</Category>
            {
                dataState.categories?.map(category => <Category
                    onClick={() => globalActions.setSelectedCategory(category.name)}
